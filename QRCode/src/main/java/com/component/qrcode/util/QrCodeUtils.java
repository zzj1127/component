...
public class QrCodeUtils {
     ...
     * @throws Exception
     */
    public static void encode(String content, String logoPath, String  name,OutputStream output, boolean needCompress)
            throws Exception {
    ...
    public static void writeImageFile(BufferedImage bi, String logoPath) throws IOException {
        File outputfile = new File("/home/zzj/bin"+logoPath+".png");
